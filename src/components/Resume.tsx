      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {highlights.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-white/10 p-6 hover:border-emerald-500/30 transition-all duration-300"
              >
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500/20 to-blue-500/20 flex items-center justify-center text-emerald-400 mb-4 group-hover:scale-110 transition-transform duration-300">
                    <item.icon size={24} />
                  </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-white/10 p-8 md:p-12"
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <button
                  onClick={handleView}
                  className="group relative px-8 py-4 bg-gradient-to-r from-emerald-600 to-emerald-500 text-white rounded-xl font-semibold shadow-xl shadow-emerald-500/20 hover:shadow-emerald-500/40 transition-all duration-300 hover:scale-105 hover:-translate-y-0.5 flex items-center gap-3 min-w-[200px] justify-center"
                >
                  <Eye size={20} />
                ...
                <button
                  ...
                  className="group relative px-8 py-4 bg-slate-800/80 backdrop-blur-sm text-white rounded-xl font-semibold border border-slate-700 hover:bg-slate-800 hover:border-emerald-500/50 transition-all duration-300 hover:scale-105 hover:-translate-y-0.5 flex items-center gap-3 min-w-[200px] justify-center"
                >
                  <Download size={20} />
